...
namespace WardrobeMVC.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,Name,Photo,Type,Color,SeasonID,Occacion")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,Name,Photo,Type,Color,SeasonID,Occacion")] Top top)
        {
            if (ModelState.IsValid)
            {
